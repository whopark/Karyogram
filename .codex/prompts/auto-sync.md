...
3. `Completion Verdict` 결과
   ...
   - `Evolution Ideas`는 optional improvement로만 표시하고 자동 follow-up SPEC이나 sibling SPEC으로 추천하지 않습니다.
...
7. 완료 배너/다음 단계 출력은 위 gate를 기록한 뒤에만 수행합니다.
...
동기화 완료 후 Evolution Ideas는 선택 제안으로만 보여주고, 배포 검증을 권장합니다: `@auto canary`
