...
def display_sidebar_settings() -> Tuple[APIProvider, Optional[str], Dict]:
    ...
    with st.sidebar:
        ...
        # REQ-1: Provider selector always visible (outside any expander)
        ...
        # REQ-2: API key section in collapsed expander
        api_key = None
        consensus_keys: Dict = {}
        ...
        # REQ-3: Status and About section in collapsed expander
        with st.expander("ℹ️ Status & Info", expanded=False):
            display_api_status()
            st.markdown("""
            ### About
        ...
        # REQ-4: Return value contract preserved
