...
10. **CAM Explainability**: Class Activation Map visualization for chromosome classification — heatmap overlays showing which regions drove the classifier's prediction (Streamlit toggle + CLI)
